exports.customerPage = class customerPage{
    ...
    constructor(page){
        ...
        this.page = page;
        this.customerMenu = page.locator('//html[1]/body[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/ul[1]/li[4]/a[1]/span[1]')
        this.customerHeading = page.getByRole('heading',{name: 'Customers'})
        this.cDropDownSelector = page.locator('DataTables_Table_0_length')
   ...
   async cDropDownNavigation(){
    ...
    await this.cDropDownSelector.selectOption({value: '10'})
   }
}



// this.sNOGrid =page.getByRole('columnheader',{name:'sorting_disabled sorting_asc'})
